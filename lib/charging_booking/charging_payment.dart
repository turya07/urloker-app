...
class ChargingPaymentScreen extends StatefulWidget {
  ...
  const ChargingPaymentScreen({super.key, required this.amount,});
  final double amount;

  @override
  State<ChargingPaymentScreen> createState() => _ChargingPaymentScreenState();
}

class _ChargingPaymentScreenState extends State<ChargingPaymentScreen> {
  ...
  @override
  void didUpdateWidget(ChargingPaymentScreen oldWidget) {
